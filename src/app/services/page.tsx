...
const services = [
  ...
  },
  {
    ...
    what: 'A franchise technology platform is where the whole network reports in. We build and deploy the software infrastructure your franchise needs to operate: franchisee portals, royalty tracking, compliance management, performance dashboards, communication tools, and integrated payment processing. This is not off the shelf software with your logo on it. It is a platform configured for how your specific franchise operates.',
    why: 'Managing five franchise locations with spreadsheets and email is possible. Managing fifty is not. The franchise systems that scale successfully are the ones that invest in technology infrastructure early. Royalty collection, franchisee communication, brand compliance, performance benchmarking. Each one is a minor chore at five units and a full time job at fifty. Technology also becomes a competitive advantage in franchise sales. When a prospective franchisee sees that you have a real platform (not a shared Google Drive), it signals that you are serious about supporting your network.',
    deliver: [
